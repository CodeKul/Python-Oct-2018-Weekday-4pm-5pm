...
t1 = threading.Thread(target=downloadImage, args=[url1,'ironMan1.png'])
t1.start()

t2 = threading.Thread(target=downloadImage, args=[url2,'ironMan2.png'])
t2.start()

t3 = threading.Thread(target=downloadImage, args=[url3,'ironMan3.png'])
t3.start()